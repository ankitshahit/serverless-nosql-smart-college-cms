...
public class CourseController {
	...
	public FactoryResponse createUpdateCourse(CourseEntity courseEntity, HttpServletRequest request,
			HttpServletResponse response) {
		LOGGER.debug("Course name {0}");
	...
	public FactoryResponse deleteCourse(CourseEntity courseEntity, HttpServletRequest request,
			HttpServletResponse response) {
		LOGGER.debug("Course name {0}");
